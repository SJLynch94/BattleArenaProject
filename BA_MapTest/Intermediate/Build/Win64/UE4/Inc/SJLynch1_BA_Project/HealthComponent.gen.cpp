...
// End Cross Module References
	UFunction* Z_Construct_UDelegateFunction_SJLynch1_BA_Project_OnArmourChangedSignature__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Health = { UE4CodeGen_Private::EPropertyClass::Float, "Health", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(_Script_SJLynch1_BA_Project_eventOnArmourChangedSignature_Parms, Health), METADATA_PARAMS(nullptr, 0) };
	...
	IMPLEMENT_CLASS(UHealthComponent, 2186592399);
